---
title: "WebsiteFilter"
description: "Block websites, domains, or other URLs from being visited."
category: "Browsing restrictions"
---

Block websites, domains, or other URLs from being visited.
...
- You can specify protocols using `https://*/*` for HTTPS or `http://*/*` for HTTP, for example.
